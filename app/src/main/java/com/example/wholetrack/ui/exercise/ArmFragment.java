...
import com.example.wholetrack.databinding.FragmentArmBinding;


public class ArmFragment extends Fragment {
    private FragmentArmBinding binding;
...
//        View root = binding.getRoot();
        binding = FragmentArmBinding.inflate(inflater, container,false);
        View root = binding.getRoot();
